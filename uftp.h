...
#define sleep(t) Sleep((int)(t)*1000)
...
typedef struct __utimbuf64 utim_buf;
...
#define VERSIONSTR "UFTP version 5.0.1  Copyright (C) 2001-2022  Dennis A. Bush"
#define UFTP_VER_NUM 0x50
#define UFTP4_VER_NUM 0x40
...
#define HB_REQ       14
#define HB_RESP      15
// obsolete, keeping for v4 compatibility
#define KEY_REQ      16
#define PROXY_KEY    17
#define ENCRYPTED    18
#define ABORT        19 
...
#define KEY_NONE        0
// reserved, obsolete: 1-4, keeping 3-4 for v4 compatibility
...
#define HASH_NONE   0
// reserved, obsolete: 1-2, keeping 2 for v4 ECDH compatibility
#define HASH_SHA1   2
...
struct keyinfo_h {
    ...
    uint32_t iv_ctr_hi;
    uint32_t iv_ctr_lo;
};  // sizeof = 12 + siglen + {destkey[]}

struct destkey {
    uint32_t dest_id;
    uint8_t groupmaster[ENC_MASTER_LEN];
};  // sizeof = 52
